...
//        public readonly IConfigurationRoot? INIData;
...
//                .SetBasePath(Path.GetDirectoryName(iniPath)!)
//                .AddIniFile(Path.GetFileName(iniPath), optional: forceCreate);
//            INIData = builder.Build();
